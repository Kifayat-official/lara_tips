...
<div class="row">
    ...
    <div class="form-group col-md-12">
        ...
        <input type="text" class="form-control" name="wakeup_number_1" value="123456789">
    </div>

    <div class="form-group col-md-12">
        <label for="">Wakeup Number 2</label>
        <input type="text" class="form-control" name="wakeup_number_2" value="123456789">
    </div>

    <div class="form-group col-md-12">
        <label for="">Wakeup Number 3</label>
        <input type="text" class="form-control" name="wakeup_number_3" value="123456789">
    </div>

</div><?php /**PATH D:\dev\htdocs\udil2\resources\views/tests/test_forms/update_wake_up_sim_number.blade.php ENDPATH**/ ?>