...
<div id="tests_report" style="width: <?php echo e($page_width); ?>; background-color: white; position: relative;">
    ...
    <br><br><br>
    <table style="width: 100%">
    <?php if( isset($certificate_count) && count($certificate_count) > 0 ): ?>
        <?php $__currentLoopData = $certificate_count; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>  
            <?php if($key == 0): ?>      
            ...
            <td class="border-bottom">
                <b>
                    PITC/INTR/RP/<?php echo e(str_pad( $value ,6,"0",STR_PAD_LEFT)); ?>
    ...
    <table class="attributes-table" style="width: 58%">
        <tr><td style="text-align: right; width: 58%;"><b>MDC Name & Version:</b></td><td><?php echo e($mdc_test_session->mdc_name); ?>/<?php echo e($mdc_test_session->mdc_version); ?></td></tr>
        <tr><td style="text-align: right; width: 58%;"><b>MDC Size (MBs):</b></td><td><?php echo e($mdc_test_session->mdc_size); ?></td></tr>
        <tr><td style="text-align: right; width: 58%;"><b>OS Name & Version:</b></td><td><?php echo e($mdc_test_session->mdc_os_name_version); ?></td></tr>

        <tr>
            <td style="text-align: right; width: 58%;"><b>Smart Meter Serial No(s)/Model:</b></td>
            <td>
                <?php echo e(implode(', ', $mdc_test_session->meters->pluck('msn')->toArray() )); ?>/<?php echo e(implode(', ', $mdc_test_session->meters->pluck('meter_model')->toArray() )); ?>

            </td>
        </tr>

        <tr><td style="text-align: right; width: 58%;"><b>Meter Firmware Version:</b></td><td><?php echo e($mdc_test_session->meter_firmware_version); ?></td></tr>
        <tr><td style="text-align: right; width: 58%;"><b>Meter Firmware Size:</b></td><td><?php echo e($mdc_test_session->meter_firmware_size); ?></td></tr>
        <tr><td style="text-align: right; width: 58%;"><b>UDIL Version:</b></td><td><?php echo e($mdc_test_session->udil_version); ?></td></tr>
    </table>
    ...
    <table class="tests-table table-responsive" style="width: 100%">        
        <?php if( isset($certificate_list) && count($certificate_list) > 0 ): ?>
            <?php $__currentLoopData = $certificate_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <thead>
            <tr>
                <th>Sr.</th>
            ...
            <?php
                $index = 0;
            ?>
            <?php $__currentLoopData = $value->testProfile->tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <?php if($test->testType->idt == 'read'): ?>
                <tr>
                    ...
                    <td>
                        <?php if($test->testType->idt == 'read'): ?>
                            <?php echo e($value->readCommunicationProfile->communicationProfileType->name); ?>

                        <?php else: ?>
                            <?php echo e($value->writeCommunicationProfile->communicationProfileType->name); ?>
                    ...
                    <td>
                        PITC/INTR/RP/<?php echo e(str_pad( $value->id_numeric ,6,"0",STR_PAD_LEFT)); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\udil\htdocs\udil\resources\views/reports/test_certificate_report.blade.php ENDPATH**/ ?>