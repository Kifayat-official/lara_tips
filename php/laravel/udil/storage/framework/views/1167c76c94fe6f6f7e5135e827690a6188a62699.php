...
<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <input class="form-control" type="number" name="communication_interval" value="15" />
    </div>

    <?php echo \App\SelectHelper::createSelect( 'Device Type', 'device_type', \App\SelectHelper::$device_types, 'col-md-6' ); ?>


    <div class="form-group col-md-6">
        <label for="">MDI Reset Date</label>
        <input class="form-control" type="number" name="mdi_reset_date" value="1" min="1" max="28" />
    </div>

    <div class="form-group col-md-6">
        <label for="">MDC Reset Time</label>
        <input class="form-control" type="text" name="mdi_reset_time" value="00:00:00" />
    </div>

    <div class="form-group col-md-6">
        <label for="">Sim Number</label>
        <input class="form-control" type="text" name="sim_number" value="03218090100"  />
    </div>
    <div class="form-group col-md-6">
        <label for="">SIM ID</label>
        <input class="form-control" type="text" name="sim_id" value="11199oijjh78" />
    </div>
...
<?php /**PATH D:\Xamp\htdocs\testing_suite\resources\views/tests/test_forms/create_device_meter.blade.php ENDPATH**/ ?>