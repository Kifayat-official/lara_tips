...
<?php $__env->startSection('body'); ?>
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            <form action="<?php echo e(url(config('adminlte.register_url', 'register'))); ?>" method="post">
                ...
                <div class="form-group has-feedback <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
                    <input type="text" name="name" class="form-control" value="<?php echo e(old('name')); ?>"
                           placeholder="<?php echo e(__('adminlte::adminlte.full_name')); ?>">
            ...
            <br>
            <p>
                <a href="<?php echo e(url(config('adminlte.login_url', 'login'))); ?>" class="text-center">
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\udil\htdocs\udil\vendor\jeroennoten\laravel-adminlte\src/../resources/views/register.blade.php ENDPATH**/ ?>