...
<div class="row">
    ...
    <?php echo \App\SelectHelper::createSelect( 'Data Type', 'data_type', \App\SelectHelper::$data_types, 'col-md-6' ); ?>


    <div class="form-group col-md-6">
        <label for="">Sampling Interval</label>
        <input type="number" class="form-control" name="sampling_interval" value="30" min="1" max="59">
    </div>
...
</div><?php /**PATH D:\dev\htdocs\udil2\resources\views/tests/test_forms/meter_data_sampling.blade.php ENDPATH**/ ?>