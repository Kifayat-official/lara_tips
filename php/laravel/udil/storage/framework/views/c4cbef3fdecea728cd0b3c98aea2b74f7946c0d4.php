...
<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <input class="form-control" type="number" name="mdi_reset_date" value="<?php echo e(isset($meter->mdi_reset_date) ? $meter->mdi_reset_date : 1); ?>" min="1" max="28" />
    </div>

    <div class="form-group col-md-6">
        <label for="">MDC Reset Time</label>
        <input class="form-control" type="text" name="mdi_reset_time" value="<?php echo e(($meter->mdi_reset_time) ? $meter->mdi_reset_time : '00:00:00'); ?>" />
    </div>
</div><?php /**PATH D:\udil\htdocs\udil\resources\views/tests/test_forms/update_mdi_reset_date.blade.php ENDPATH**/ ?>