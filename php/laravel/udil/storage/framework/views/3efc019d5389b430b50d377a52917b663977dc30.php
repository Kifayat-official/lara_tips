...
<div class="row">
    ...
    <?php $__env->startComponent('components.datetimepicker', [
            ...
            'name' => 'start_datetime',
            'class' => 'col-md-6',
            'value' => \Carbon\Carbon::now()->addDays(-2)->format('d-M-Y H:i:s')
        ]); ?>
    <?php echo $__env->renderComponent(); ?>
...
</div><?php /**PATH /var/www/html/udil/resources/views/tests/test_forms/reading_test_through_api.blade.php ENDPATH**/ ?>