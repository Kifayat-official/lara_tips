...
<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <select class="form-control" name="device_type">
            ...
            <option value="3" <?php if($curr_meter[0]->device_type == '3'): ?> selected <?php endif; ?>>other</option>
        </select>
    </div>
    ...
    <div class="form-group col-md-6">
        ...
        <select class="form-control" name="communication_type">
            ...
            <option value="1" <?php if($curr_meter[0]->comm_type == '1'): ?> selected <?php endif; ?>>periodic-on</option>
            <option value="2" <?php if($curr_meter[0]->comm_type == '2'): ?> selected <?php endif; ?>>on-demand</option>
...
<?php /**PATH D:\dev\htdocs\udil\resources\views/tests/test_forms/create_device_meter.blade.php ENDPATH**/ ?>