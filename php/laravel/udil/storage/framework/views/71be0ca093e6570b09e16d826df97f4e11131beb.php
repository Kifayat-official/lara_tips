...
<div class="row">
    ...
    <?php $__env->startComponent('components.datetimepicker', [
            'title' => 'Optical Port On Datetime',
            'name' => 'optical_port_on_datetime',
            'class' => 'col-md-6',
    ...
    <?php $__env->startComponent('components.datetimepicker', [
            'title' => 'Optical Port Off Datetime',
            'name' => 'optical_port_off_datetime',
            'class' => 'col-md-6',
            'value' => \Carbon\Carbon::now()->addHours(1)->format('d-M-Y H:i:s')
        ]); ?>
    <?php echo $__env->renderComponent(); ?>

</div><?php /**PATH D:\dev\htdocs\udil2\resources\views/tests/test_forms/activate_meter_optical_port.blade.php ENDPATH**/ ?>