...
<script>
    ...
    $('#role_id_selector').on('focusin', function(){
                ...
                var tariffHtml = `
                                    ...
                                    <div class="form-group">
                                            <?php $__currentLoopData = \App\MdcTestSession::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tariff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option ></option>
                                                    <input type="checkbox" class="meters" name="mdc_session_id[]" value="<?php echo e($tariff->id); ?>">
                                                    <?php echo e($tariff->mdc_name); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\dev\htdocs\udil2_testing\resources\views/users/add_edit.blade.php ENDPATH**/ ?>