...
<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="number" class="form-control" name="critical_event_threshold_limit" min="0" value="0">
    </div>
    ...
    <div class="form-group col-md-6">
        ...
        <input type="number" class="form-control" name="tripping_event_threshold_limit" min="0" value="0">
    </div>
...
</div><?php /**PATH E:\dev7\htdocs\udil\resources\views/tests/test_forms/apms_tripping_events.blade.php ENDPATH**/ ?>