...
<div class="row">
    ...
    {!! \App\SelectHelper::createSelect('Type', 'type', \App\SelectHelper::$types_for_apms, 'col-md-6') !!}
    {!! \App\SelectHelper::createSelect('Enable Tripping', 'enable_tripping', \App\SelectHelper::$enable_tripping_for_apms, 'col-md-6') !!}
