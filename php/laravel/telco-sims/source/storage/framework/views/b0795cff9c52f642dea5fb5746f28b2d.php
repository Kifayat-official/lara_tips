...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container">
            <?php if(Auth::check()): ?>
                ...
                <?php if($regionCode && $regionName): ?>
                    <a class="navbar-brand" href="#">
                        <?php echo e($regionName); ?> <?php if($regionCode): ?>
                            (<?php echo e($regionCode); ?>)
                        <?php endif; ?>
                    </a>
                <?php endif; ?>
            <?php else: ?>
    ...
    <div class="container">
        <?php echo $__env->yieldContent('footer-libs'); ?>
    </div>
...
<?php /**PATH C:\Users\Kifayat Ullah\Desktop\Code Squad\AppSquad\laravel\telco_sims\TelcoSims\resources\views/auth/layouts.blade.php ENDPATH**/ ?>