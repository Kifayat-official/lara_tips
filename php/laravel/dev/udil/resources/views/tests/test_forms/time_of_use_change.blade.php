...
<div class="row">
    ...
    <div class="col-md-12">
        <h4>Day Profile</h4>
        <table id="day_profile_{{ $uniqid }}" class="table table-bordered day_profile_table">
            <thead>
                <th>Name</th>
                <th>Tariff Slabs</th>
                <th>Action</th>
        ...
        <div class="text-right">
            <button onclick="addDayProfile('#day_profile_{{ $uniqid }}')" type="button" class="btn btn-sm btn-primary">
    ...
    <div class="col-md-12">
        <h4>Week Profile</h4>
        <table id="week_profile_{{ $uniqid }}" class="table table-bordered week_profile_table">
            <thead>
                <th>Name</th>
                <th>Tariff Slabs</th>
                <th>Action</th>
        ...
        <div class="text-right">
            <button onclick="addWeekProfile('#week_profile_{{ $uniqid }}')" type="button" class="btn btn-sm btn-primary">
                <i class="fa fa-plus-circle"></i>
                Add Week Profile
            </button>
        </div>
    ...
    <div class="col-md-12">
        ...
        <table id="season_profile_{{ $uniqid }}" class="table table-bordered season_profile_table">
            <thead>
                <th>Name</th>
        ...
        <div class="text-right">
            <button onclick="addSeasonProfile('#season_profile_{{ $uniqid }}')" type="button" class="btn btn-sm btn-primary">
                <i class="fa fa-plus-circle"></i>
                Add Season Profile
            </button>
        </div>
    ...
    <div class="col-md-12">
        ...
        <table id="holiday_profile_{{ $uniqid }}" class="table table-bordered holiday_profile_table">
            <thead>
                <th>Name</th>
                <th>Date</th>
        ...
        <div class="text-right">
            <button onclick="addHolidayProfile('#holiday_profile_{{ $uniqid }}')" type="button" class="btn btn-sm btn-primary">
                <i class="fa fa-plus-circle"></i>
                Add Holiday Profile
            </button>
        </div>
